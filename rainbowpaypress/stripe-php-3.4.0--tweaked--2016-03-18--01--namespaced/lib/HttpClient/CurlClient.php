...
namespace plugin_RainbowPayPress\Stripe\HttpClient;

use plugin_RainbowPayPress\Stripe\Stripe;
use plugin_RainbowPayPress\Stripe\Error;
use plugin_RainbowPayPress\Stripe\Util;
